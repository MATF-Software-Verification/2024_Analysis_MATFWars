...
testWindow::testWindow (QWidget *parent)
    : QWidget (parent), ui (new Ui::testWindow), m_canvas (new Canvas (this))
{
  ui->setupUi (this);
  ...
  // signali i slotovi
  connect (ui->pbInput, &QPushButton::clicked, this,
           &testWindow::setNewFunction);
  connect (this, &testWindow::newFunctionIsSet,
...
testWindow::setNewFunction ()
{
  ...
  const auto node = new FunctionNode (newFunction, sceneRect.width (),
                                      sceneRect.height ());
