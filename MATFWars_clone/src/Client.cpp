...
Client::Client (QObject *parent, const QString hostAddress, quint16 portNumber)
    : m_NextBlockSize (0)
{
...
void
Client::receivedSomething (QString msg)
{
  emit someMessage (msg);
}

void
Client::gotError (QAbstractSocket::SocketError err)
{
...
void
Client::setName (const QString &newName)
{
  m_name = newName;
}
...
void
Client::setHost (const QString &newHost)
{
  m_host = newHost;
}
...
void
Client::setPort (quint16 newPort)
{
  m_port = newPort;
}
