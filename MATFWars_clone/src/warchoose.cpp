...
WarChoose::WarChoose (QWidget *parent)
    : QDialog (parent), ui (new Ui::WarChoose)
{
  ui->setupUi (this);
...
void
WarChoose::on_create_choose_button_clicked ()
{
  this->hide ();
  ptrCreate->show ();
}
...
void
WarChoose::on_join_choose_button_clicked ()
{
  this->hide ();
  ptrJoin->show ();
}
...
void
WarChoose::on_back_choose_button_clicked ()
{
