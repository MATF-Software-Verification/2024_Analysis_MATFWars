...
private:
  ...
  // Generates a linearly spaced QVector of y-coordinates corresponding to the
  // x-coordinates
...
public:
  ...
  Function (std::string function, double startX = -15, double endX = 15,
            int numX = 1000);

  QVector<QPointF> points ();

  // Translates coordinates of function so that coordinate origin is in (currX,
  // currY) point
