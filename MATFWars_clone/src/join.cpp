...
Join::Join (QWidget *parent) : QDialog (parent), ui (new Ui::Join)
{
...
void
Join::on_back_pop2_button_clicked ()
{
...
void
Join::on_join_pop2_button_clicked ()
{

  m_client = new Client (nullptr, ui->ip_lineEdit->text (),
...
void
Join::clientReceivedMessage (QString msg)
{
