...
Create::Create (QWidget *parent) : QDialog (parent), ui (new Ui::Create)
{
  ui->setupUi (this);
...
void
Create::on_back_pop1_button_clicked ()
{
...
void
Create::on_create_pop1_button_clicked ()
{
  m_client = new Client (nullptr, "localhost",
...
void
Create::gotError (QAbstractSocket::SocketError err)
{
