    ...
    : QMainWindow (parent), ui (new Ui::MainWindow)
{
  ...
  connect (ptrWarChoose, &WarChoose::backChooseClicked, this,
           &MainWindow::show);
  connect (ptrChooseDifficulty, &ChooseDifficulty::backDifficultyClicked, this,
           &MainWindow::show);
...
void
MainWindow::on_war_game_button_clicked ()
{
  this->hide ();
  ptrWarChoose->show ();
}
...
void
MainWindow::on_leaderboard_main_button_clicked ()
{
...
void
MainWindow::on_tool_button_clicked ()
{
  ptrSettings->show ();
}
...
MainWindow::eventFilter (QObject *obj, QEvent *event)
{
  ...
  else if (obj == ui->leaderboard_main_button
           && event->type () == QEvent::Enter)
    {
      ui->leaderboard_main_button->setCursor (Qt::PointingHandCursor);
      ui->leaderboard_main_button->setStyleSheet (
          leaderboardStyle + "border: 8px solid rgb(59, 23, 23);");
    }
...
void
MainWindow::on_guess_game_button_clicked ()
{
