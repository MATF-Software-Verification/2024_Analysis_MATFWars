...
QT_MOC_LITERAL(6, 12), // "timerExpired"
QT_MOC_LITERAL(19, 0), // ""
QT_MOC_LITERAL(20, 9) // "secPassed"

    },
    "Timer\0timerExpired\0\0secPassed"
};
...
void Timer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Timer::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Timer::timerExpired)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Timer::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Timer::secPassed)) {
                *result = 1;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<Timer, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
